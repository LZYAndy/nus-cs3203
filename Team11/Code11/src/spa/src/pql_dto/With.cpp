...
namespace pql_dto
{
    ...
    {
        if ((first_param.is_entity_declared() && first_param.get_entity_attr() == AttributeType::NONE)
            || (second_param.is_entity_declared() && second_param.get_entity_attr() == AttributeType::NONE))
        {
