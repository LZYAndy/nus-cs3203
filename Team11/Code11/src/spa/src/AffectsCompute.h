...
public:
     ...
     */
    std::vector<int> get_assigns_affected_by(int stmt, int last_stmt_num, NextBank& next_bank, ModifiesBank& modifies_bank, UsesBank& uses_bank, TypeBank& type_bank, bool called_from_get_all_relationship);
    /**
     ...
     */
    bool is_affects(int stmt1, int stmt2, int last_stmt_num, NextBank& next_bank, ModifiesBank& modifies_bank, UsesBank& uses_bank, TypeBank& type_bank);
    /**
     * Clear affects cache
     */
    void clear_cache();
