...
unordered_map<string, vector<string>> NextBipStarEvaluator::evaluate_non_trivial(pql_dto::Entity &first_param,
...
bool NextBipStarEvaluator::evaluate_trivial(pql_dto::Entity &first_param,
        pql_dto::Entity &second_param, PKB &PKB)
{
    bool result = false;
    string first_name = first_param.get_entity_name();
...
//        {
//            // e.g. NextBip*(1, 2)
//            result = PKB.is_next_bip_star(stoi(first_name), stoi(second_name));
//        }
//    }
    return result;
}
