...
//
//unordered_map<string, vector<string>> AffectsStarEvaluator::evaluate_non_trivial(pql_dto::Entity &first_param,
...
//        {
//            // e.g. Affects*(a, 2)
//            vector<int> int_vec = PKB.get_assigns_affect_star(stoi(second_name));
//            result = QueryUtility::mapping(first_param, int_vec, PKB);
//        }
//        else
//        {
...
//        {
//            // e.g. Affects*(1, a)
//            vector<int> int_vec = PKB.get_assigns_affected_star_by(stoi(first_name));
//            result = QueryUtility::mapping(second_param, int_vec, PKB);
//        }
//    }
//    return result;
//}
//
//bool AffectsStarEvaluator::evaluate_trivial(pql_dto::Entity &first_param,
//        pql_dto::Entity &second_param, PKB &PKB)
//{
//    bool result = false;
//    string first_name = first_param.get_entity_name();
...
//        {
//            // e.g. Affects*(_, 2)
//            result = !PKB.get_assigns_affect_star(stoi(second_name)).empty();
//        }
//    }
//
...
//        {
//            // e.g. Affects*(1, _)
//            result = !PKB.get_assigns_affected_star_by(stoi(first_name)).empty();
//        }
//        else if (QueryUtility::is_statement_num(second_param))
//        {
//            // e.g. Affects*(1, 2)
//            result = PKB.is_affects_star(stoi(first_name), stoi(second_name));
//        }
//    }
//    return result;
//}
