...
TEST_CASE("Test analyse() method for multiple procedures input 3.")
{
    ...
    std::string correct_name1 = "main";
    std::string correct_body1 = " flag = 0; call computeCentroid; call printResults; ";
    std::string name_got1 = procedure1.get_name();
    std::string body_got1 = procedure1.get_body();
    ...
    std::string correct_name2 = "readPoint";
    std::string correct_body2 = " read x; read y; ";
    std::string name_got2 = procedure2.get_name();
    std::string body_got2 = procedure2.get_body();
    ...
    std::string correct_name3 = "printResults";
    std::string correct_body3 = " print flag; print cenX; print cenY; print normSq; ";
    std::string name_got3 = procedure3.get_name();
    std::string body_got3 = procedure3.get_body();

    REQUIRE(correct_name3 == name_got3);
    REQUIRE(correct_body3 == body_got3);

    std::string correct_name4 = "computeCentroid";
    std::string correct_body4 = " count = 0; cenX = 0; cenY = 0; call readPoint; while ((x != 0) && (y != 0)) { count = count + 1; cenX = cenX + x; cenY = cenY + y; call readPoint; } if (count == 0) then { flag = cenX; } else { cenX = cenX / count; cenY = cenY / count; } normSq = cenX * cenX + cenY * cenY;";
    std::string name_got4 = procedure4.get_name();
    std::string body_got4 = procedure4.get_body();

    REQUIRE(correct_name4 == name_got4);
    REQUIRE(correct_body4 == body_got4);
}
