...
TEST_CASE("NextStarCompute::get_statements_previous_star()")
{
    ...
    {
        result = next_star_compute.get_statements_previous_star(1, next_bank);
        REQUIRE(result.size() == 0);
    }

    SECTION("return 1 statement")
    {
        result = next_star_compute.get_statements_previous_star(2, next_bank);
    ...
    {
        result = next_star_compute.get_statements_previous_star(9, next_bank);
...
TEST_CASE("NextStarCompute::get_statements_next_star()")
{
    ...
    SECTION("return 0 statement")
    {
        result = next_star_compute.get_statements_next_star(10, next_bank);
        REQUIRE(result.size() == 0);
    }

    SECTION("return 1 statement")
    {
        result = next_star_compute.get_statements_next_star(9, next_bank);
        REQUIRE(result.size() == 1);
        REQUIRE(result[0] == 10);
    }
    ...
    SECTION("return more than 1 statement")
    {
        result = next_star_compute.get_statements_next_star(3, next_bank);
        //REQUIRE(result.size() == 8);
        for(int i = 3; i <= 10; i++)
        {
            expected.push_back(i);
...
TEST_CASE("NextStarCompute::is_next_star()")
{
    ...
    {
       REQUIRE_FALSE(next_star_compute.is_next_star(2, 1, next_bank));
       REQUIRE_FALSE(next_star_compute.is_next_star(3, 2, next_bank));
       REQUIRE_FALSE(next_star_compute.is_next_star(3, 1, next_bank));
       REQUIRE_FALSE(next_star_compute.is_next_star(10, 9, next_bank));
       REQUIRE_FALSE(next_star_compute.is_next_star(9, 7, next_bank));
    }

    SECTION("return true")
    {
        REQUIRE(next_star_compute.is_next_star(3, 3, next_bank));
        REQUIRE(next_star_compute.is_next_star(5, 5, next_bank));
        REQUIRE(next_star_compute.is_next_star(6, 3, next_bank));
        REQUIRE(next_star_compute.is_next_star(7, 9, next_bank));
        REQUIRE(next_star_compute.is_next_star(5, 7, next_bank));
    }
}
