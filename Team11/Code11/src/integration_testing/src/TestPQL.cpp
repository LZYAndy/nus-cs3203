...
//    }
    ...
    SECTION("select tuple, multiple clauses")
    {
        ...
        unordered_set<string> expected_result {"FALSE"};
        REQUIRE(QueryEvaluator::get_result(pql_query, PKB) == expected_result);
    }

    SECTION("select tuple, multiple clauses")
    {
        string pql_query = "while w1, w2; Select BOOLEAN such that Follows(w1, w2) and Follows(w2, w1)";// "assign a1, a2, a3; Select <a1, a2, a3> such that Affects(a1, a2) and Affects(a2, a3) and Affects(a3, a1)";
        unordered_set<string> expected_result {};
        REQUIRE(QueryEvaluator::get_result(pql_query, PKB) == expected_result);
    }
}
