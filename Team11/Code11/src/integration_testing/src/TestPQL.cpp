...
//    int i = parser.parse("procedure main {\n"
//                         "   x = 100;\n"
//                         "   read z;\n"
//                         "   y = x + z;\n"
//                         "   print y;\n"
//                         "   x = alpha + beta * ( gamma - delta) % ( epsilon / zeta + eta) - theta * 100;\n"
//                         "   if (x > 0) then {\n"
//                         "       a = b + 1;\n"
//                         "       b = b + 1;\n"
//                         "       while (b > 0) {\n"
...
//                         "                  theta = theta + 1;}\n"
//                         "              else {\n"
//                         "                  delta = delta + 100 * sigma;\n"
//                         "                  sigma = sigma + sigma + sigma +sigma + sigma + delta + delta;\n"
//                         "                  delta = delta - 1;}\n"
//                         "              if (alpha > 0) then {\n"
//                         "                  alpha = alpha - 1;\n"
//                         "                  sigma = b - a;}\n"
//                         "              else {\n"
//                         "                  epsilon = epsilon + ( a + b * e ) + c + d + e + alpha;}\n"
//                         "              while (x > t) {\n"
//                         "                  x = t + 1;\n"
//                         "                  t = t - 100;}\n"
//                         "              call second;\n"
...
//                         "  else {\n"
//                         "      y = 100;}}");
//    string pql_query = "assign a; if ifs; variable v; Select a such that Next(ifs, a) and Modifies(a, v) and Uses(a, v)";
//    unordered_set<string> expected_result {"16", "19", "23", "25"};
