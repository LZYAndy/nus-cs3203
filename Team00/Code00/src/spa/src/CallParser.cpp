...
CallParser::CallParser(PKB pkb, Statement statement, string parent_prog_line)
{
    ...
    string call_proc = get_proc(statement.get_statement());
...
bool CallParser::is_call_stmt_valid(string statement)
{
...
string CallParser::get_proc(string statement)
{
    smatch match;
